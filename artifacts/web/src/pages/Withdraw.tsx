...
export default function Withdraw() {
  ...
  return (
    <div className="min-h-screen max-w-md mx-auto bg-gradient-to-br from-blue-50 via-green-50 to-purple-50">
      ...
      <div className="mx-4 mt-4 rounded-2xl p-4 text-white shadow-md mb-5" style={{ background: 'linear-gradient(135deg, #10b981, #3b82f6)' }}>
      ...
      <div className="px-4">
        <button
          ...
          className="w-full bg-gradient-to-r from-emerald-500 to-blue-500 disabled:opacity-50 text-white font-bold py-3.5 rounded-2xl shadow-lg"
        >
          Submit Withdrawal
        </button>
      </div>
